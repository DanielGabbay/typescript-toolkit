...
describe('formatting utilities', () => {
  describe('template', () => {
    ...
    it('should escape HTML when escape option is true', () => {
      const result = template('Message: {{msg}}', { msg: '<script>alert()</script>' }, {
        escape: true
      });
  ...
  describe('truncate', () => {
    ...
    it('should truncate at separator when provided', () => {
      expect(truncate('Hello World Test', 10, { separator: /\s/ })).toBe('Hello...');
    });
  ...
  describe('wordWrap', () => {
    ...
    it('should break long words when breakLongWords is true', () => {
      const result = wordWrap('Supercalifragilisticexpialidocious', 10, { break: true });
